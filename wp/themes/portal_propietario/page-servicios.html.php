            ...
            <div class="servicios-plus">
                <div>
                    <button a="" href="#" class="notario">
                        <img src="<?php echo get_template_directory() . '/assets/img/'?>agente.png" width="100%">
                        <h2>Notario</h2>
                ...
                <div>
                    <button a="" href="#" class="certificado-energetico">
                        <img src="<?php echo get_template_directory() . '/assets/img/'?>clase-energetica.png" width="100%">
                ...
                <div>
                    <button a="" href="#" class="nota-simple">
                        <img src="<?php echo get_template_directory() . '/assets/img/'?>escritura.png" width="100%">
                        <h2>Nota Simple</h2>
                ...
                <div>
                    <button a="" href="#" class="reportaje-fotografico">
                        <img src="<?php echo get_template_directory() . '/assets/img/'?>galeria.png" width="100%">
