<?php
/**
 * Template Name: page-admin-asesor-mbl.html
 * The template for displaying admin-asesor-mbl.html
 *
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && current_user_can('administrator')) {
    ...
    $users_to_change = get_users(array(
        ...
        'meta_value' => $viejoasesor, 'nopaging' => true
    ));
        ...
        <div class="style-box">
            <table class="default">
                <thead>
                    <tr>
                        <th>Asesor </th>
                        <th style="width: 20px">Gestionar</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
foreach (get_users(array('role__in' => array( 'administrator' ), 'nopaging' => true)) as $user_admin) {
    $users_of_admin = get_users(array(
        'meta_key' => 'meta-gestor-asignado',
        'meta_value' => $user_admin->ID, 'nopaging' => true
    ));
                    ?>
                    <tr>
